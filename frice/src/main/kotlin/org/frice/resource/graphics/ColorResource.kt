...
class ColorResource private constructor(
		val color: Int,
		private var colortmpobj: Color?) : FResource {
	...
	companion object {
		...
		@JvmField val DARK_GRAY = ColorResource(0xA9A9A9)
		@JvmField val LIGHT_GRAY = ColorResource(192, 192, 192)
		...
		@JvmField val COLORLESS = ColorResource(0)
